            ...
            <div class="col-md-4">
                <form action="{{route('admin.product.update',[$product->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="product_title" name="product_title" value="{{$product->product_title}}" class="form-control">
                    </div>
                    <div class="form-group">
                        <select class="form-control" name="category_id" id="category_id">
                            <option>Select Category</option>
                            @foreach($categories as $category_id => $category_name)
                            <option value="{{ $category_id}}" @if($product->category_id == $category_id) selected @endif>{{ $category_name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product_sku" id="product_sku" value="{{$product->product_sku}}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="product_description">Product Description</label>
                        <input type="text" name="product_description" id="product_description" value="{{$product->product_description}}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="cost_price">Product Cost Price</label>
                        <input type="text" name="cost_price" id="cost_price" value="{{$product->cost_price}}" class="form-control">
                    </div>
